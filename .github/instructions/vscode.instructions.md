---
applyTo: "config/optional/Code/**,config/optional/Code - Insiders/**"
...
- Start from `config/optional/Code/` or `config/optional/Code - Insiders/` and stay within this domain unless the change clearly depends on shell, bootstrap, or Neovim context.
